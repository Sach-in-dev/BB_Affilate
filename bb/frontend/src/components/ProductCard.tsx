  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-square overflow-hidden bg-muted/40">
        ...
        {off > 0 && (
          <span className="absolute left-2 top-2 rounded-full bg-[#962E3C] px-2 py-0.5 text-[11px] font-semibold text-white">
            {off}% OFF
          </span>
        )}
          ...
          <button
            ...
            className={cn(
              ...
              selected
                ...
                : "bg-white/90 text-[#962E3C] hover:bg-white"
            )}
          >
