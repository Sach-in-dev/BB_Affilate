...
async def create_admin_user(
    ...
    permissions = body.permissions if body.permissions is not None else list(role.permissions)
...
async def update_admin_user(
    ...
    if body.role_name is not None:
        ...
        # If no explicit permissions supplied alongside the role change, reset to role defaults.
